      ...
      <form onSubmit={handleSave} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="glass-panel p-6 rounded-xl border border-white/5 space-y-6">
            ...
            {/* Prompt Textarea */}
            <div>
              <label className="block font-semibold text-gray-400 uppercase tracking-wider mb-2">
              ...
              <textarea
                ...
                rows={6}
                className="w-full bg-black/40 border border-white/10 rounded-lg p-3 text-white outline-none focus:border-violet-500 font-sans leading-relaxed"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="block font-semibold text-gray-400 uppercase tracking-wider mb-2">Tone</label>
                <select
                  value={tone}
              ...
              <div>
                <label className="block font-semibold text-gray-400 uppercase tracking-wider mb-2">Opening Greeting</label>
                <input
                  type="text"
                  value={greeting}
              ...
              <div>
                <label className="block font-semibold text-gray-400 uppercase tracking-wider mb-2">Confidence Threshold</label>
                <input
                  type="number"
                  step="0.05"
                  min="0.1"
            ...
            {/* Closing Signature */}
            <div>
              <label className="block font-semibold text-gray-400 uppercase tracking-wider mb-2">Closing Signature</label>
              <textarea
                value={closing}
        ...
        <div className="space-y-6">
          ...
          <div className="glass-panel p-6 rounded-xl border border-white/5 space-y-6">
            ...
            <div className="space-y-4">
              <label className="flex items-start gap-3 p-3 rounded-lg border border-white/5 bg-white/5 cursor-pointer hover:bg-white/10 transition-colors">
                ...
                />
                <div>
                  <p className="font-semibold text-white">AI Draft → Human Approval</p>
              ...
              <label className="flex items-start gap-3 p-3 rounded-lg border border-white/5 bg-white/5 cursor-pointer hover:bg-white/10 transition-colors">
                ...
                />
                <div>
                  <p className="font-semibold text-white">Fully Automatic</p>
                  <p className="text-[10px] text-gray-400 mt-0.5">
          ...
          <button
            type="submit"
            className="w-full flex justify-center items-center gap-1.5 px-4 py-2.5 bg-violet-600 hover:bg-violet-500 text-xs font-semibold rounded-lg text-white transition-all cursor-pointer shadow-lg shadow-violet-600/15"
          >
            {isSaved ? (
              <>
